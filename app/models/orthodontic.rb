class Orthodontic < ActiveRecord::Base
  	attr_accessible :full_name, :address, :age, :occupation, :mobile_no, :resident_tel, :status, :birth_date, :sex, :reffered_by, :birthplace, :examination_date, :examination_result
